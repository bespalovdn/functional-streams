...
object FStream
{
        ...
        extends FStream[A, B]
    {
        ...
        override def preSubscribe(keepSubscribed: Boolean): Unit = upStream.preSubscribe(keepSubscribed)
        override def preSubscriptionStop(): Unit = upStream.preSubscriptionStop()
